...
config :streamsync, StreamsyncWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: StreamsyncWeb.ErrorHTML, json: StreamsyncWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Streamsync.PubSub,
  live_view: [signing_salt: "0GcpxeTZ"]
